...
(function() {
    ...
    function u(n, r) {
        ...
        if (n.src)
            if (/^data\:/i.test(n.src)) i(function(e, t) {
            ...
            o.onload = function() {
                ...
                i(o.response), o = null
            }, o.open("GET", n.src, !0), o.responseType = "arraybuffer", o.send(null)
    ...
    function c(t) {
        var n = new DataView(t);
        if (e && console.log("Got file of length " + t.byteLength), 255 != n.getUint8(0) || 216 != n.getUint8(1)) return e && console.log("Not a valid JPEG"), !1;
        for (var r, i = 2, o = t.byteLength; i < o;) {
            ...
            if (r = n.getUint8(i + 1), e && console.log(r), 225 == r) return e && console.log("Found 0xFFE1 marker"), h(n, i + 4, n.getUint16(i + 2));
            i += 2 + n.getUint16(i + 2)
        }
    }
    var d = {
    ...
    function f(e, t, n) {
        for (var r, i, o, a, s = new DataView(e), l = {}, u = t; u < t + n;) 28 === s.getUint8(u) && 2 === s.getUint8(u + 1) && (a = s.getUint8(u + 2)) in d && ((o = s.getInt16(u + 3)) + 5, i = d[a], r = p(s, u + 5, o), l.hasOwnProperty(i) ? l[i] instanceof Array ? l[i].push(r) : l[i] = [l[i], r] : l[i] = r), u++;
        return l
    }

    function g(t, n, r, i, o) {
        var a, s, l, u = t.getUint16(r, !o),
            c = {};
        for (l = 0; l < u; l++) a = r + 12 * l + 2, !(s = i[t.getUint16(a, !o)]) && e && console.log("Unknown tag: " + t.getUint16(a, !o)), c[s] = m(t, a, n, r, o);
        return c
    }
